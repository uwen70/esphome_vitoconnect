  ...
  namespace vitoconnect
  {
    ...
    bool OptolinkGWG::_drop_invalid_queue_entries_()
    {
      while (_queue.size() > 0)
      {
        ...
        else
        {
          ...
          case 0x49:
            requires_read = true;
            break; // PHYSICAL XRAM READ
          case 0x50:
            requires_write = true;
            break; // PHYSICAL XRAM WRITE
          case 0x51:
            requires_read = true;
            break; // PHYSICAL PORT READ
          case 0x52:
            requires_write = true;
            break; // PHYSICAL PORT WRITE
          case 0x53:
            requires_read = true;
            break; // PHYSICAL BE READ
          case 0x54:
            requires_write = true;
            break; // PHYSICAL BE WRITE
          case 0x65:
            requires_read = true;
            break; // PHYSICAL KMBUS RAM READ (read-only)
          case 0x67:
            requires_read = true;
            break; // PHYSICAL KMBUS EEPROM READ (read-only)
          default:
            supported = false;
            break;
          }
    ...
    void OptolinkGWG::_send()
    {
      ...
      else
      {
        ...
        case 0x65:
          type = 0x33;
          break; // PHYSICAL KMBUS RAM READ
        case 0x67:
          type = 0x43;
          break; // PHYSICAL KMBUS EEPROM READ
        default:
          type_ok = false;
          break;
        }
